...
using ProcurementSystem.Services.Matching;
using ProcurementSystem.Services.Matching.Auth;
using ProcurementSystem.Services.Matching.Observability;
using Scalar.AspNetCore;
using Serilog;

var builder = WebApplication.CreateBuilder(args);

builder.AddObservability("procurement-matching");
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        o.WithTitle("Procurement Matching API");
