...
using ProcurementSystem.Services.Catalog;
using ProcurementSystem.Services.Catalog.Auth;
using ProcurementSystem.Services.Catalog.BackgroundServices;
using ProcurementSystem.Services.Catalog.Observability;
...
builder.AddObservability("procurement-catalog");
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        o.WithTitle("Procurement Catalog API");
