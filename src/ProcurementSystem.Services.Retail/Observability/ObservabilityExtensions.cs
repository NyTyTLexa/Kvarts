...
namespace ProcurementSystem.Services.Retail.Observability;

public static class ObservabilityExtensions
{
    /// <summary>
    /// Структурные логи (Serilog) + трассировка/метрики OpenTelemetry → OTLP.
    /// Скопировано из соседей, чтобы сервис не ссылался на Infrastructure.
    /// </summary>
