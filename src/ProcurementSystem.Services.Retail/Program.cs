...
using ProcurementSystem.Services.Retail;
using ProcurementSystem.Services.Retail.Auth;
using ProcurementSystem.Services.Retail.Observability;
...
builder.AddObservability("procurement-retail");
...
builder.Services.AddRetailInfrastructure(builder.Configuration);
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        o.WithTitle("Procurement Retail API");
