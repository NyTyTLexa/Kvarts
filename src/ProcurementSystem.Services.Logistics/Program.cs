...
using ProcurementSystem.Services.Logistics;
using ProcurementSystem.Services.Logistics.Auth;
using ProcurementSystem.Services.Logistics.BackgroundServices;
using ProcurementSystem.Services.Logistics.Observability;
...
builder.AddObservability("procurement-logistics");
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        o.WithTitle("Procurement Logistics API");
