...
/// <summary>EF-конфигурация приёмки. Подхватывается ApplyConfigurationsFromAssembly.</summary>
public class GoodsReceiptConfiguration : IEntityTypeConfiguration<GoodsReceipt>
{
    public void Configure(EntityTypeBuilder<GoodsReceipt> e)
    {
        ...
        // OrderId — снимок ссылки на заказ соседнего сервиса, без внешнего ключа.
    }
}
...
public class GoodsReceiptLineConfiguration : IEntityTypeConfiguration<GoodsReceiptLine>
{
    public void Configure(EntityTypeBuilder<GoodsReceiptLine> e)
    {
        ...
        // ProductId — голый Guid без FK: наименование/артикул/цена уже в снимке строки.
    }
}
