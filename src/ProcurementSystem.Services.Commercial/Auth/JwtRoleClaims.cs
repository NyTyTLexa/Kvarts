...
namespace ProcurementSystem.Services.Commercial.Auth;

/// <summary>
/// Keycloak кладёт роли в JSON realm_access; без ClaimTypes.Role политика admin даёт 403/500.
/// </summary>
public static class JwtRoleClaims
{
    ...
    public static void CopyToIdentity(TokenValidatedContext ctx)
    {
        ...
        {
            // Разбор ролей не должен ронять запрос 500.
        }
    }
