...
{
    /// <summary>
    /// Наблюдаемость: структурные логи (Serilog) + распределённая трассировка и метрики
    /// (OpenTelemetry → OTLP → Jaeger). Эндпоинт OTLP — из конфигурации (Otlp:Endpoint),
    /// по умолчанию gRPC :4317.
    /// </summary>
