...
using ProcurementSystem.Services.Notifications;
using ProcurementSystem.Services.Notifications.Auth;
using ProcurementSystem.Services.Notifications.BackgroundServices;
using ProcurementSystem.Services.Notifications.Observability;
...
builder.AddObservability("procurement-notifications");
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        o.WithTitle("Procurement Notifications API");
