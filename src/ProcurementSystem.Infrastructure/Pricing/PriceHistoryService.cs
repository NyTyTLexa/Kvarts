...
namespace ProcurementSystem.Infrastructure.Pricing;
...
public class PriceHistoryService(AppDbContext db) : IPriceHistoryService
{
...
public static class PriceHistoryExtensions
{
    ...
    /// </summary>
    public static void RecordPriceChange(this AppDbContext db, Guid productId, Guid vendorId, decimal price, int leadTimeDays) =>
