...
public static class ObservabilityExtensions
{
    ...
    public static IHostApplicationBuilder AddObservability(this IHostApplicationBuilder builder, string serviceName)
    {
        ...
        builder.Services.AddOpenTelemetry()
            ...
            .WithTracing(t => t
                .AddSource(Telemetry.SourceName)        // наши бизнес-спаны (quote.generate, index.product)
                .AddSource("NATS.Net")                  // публикация/потребление в JetStream — связывает Api↔Worker
