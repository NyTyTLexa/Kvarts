...
{
    /// <summary>
    /// Структурные логи (Serilog) + трассировка/метрики OpenTelemetry → OTLP → Jaeger.
    /// Скопировано из монолита, чтобы сервис не ссылался на Infrastructure.
    /// Эндпоинт OTLP — Otlp:Endpoint, по умолчанию gRPC :4317.
    /// </summary>
