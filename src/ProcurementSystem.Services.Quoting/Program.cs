...
using ProcurementSystem.Services.Quoting;
using ProcurementSystem.Services.Quoting.Auth;
...
builder.AddObservability("procurement-quoting");
...
builder.Services.AddQuotingInfrastructure(builder.Configuration);
...
if (app.Environment.IsDevelopment())
{
    ...
    {
        o.WithTitle("Procurement Quoting API");
